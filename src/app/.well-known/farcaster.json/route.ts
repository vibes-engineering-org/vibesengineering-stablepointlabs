...
export async function GET() {
  return NextResponse.json({
    accountAssociation: {
      ...
      signature:
        "MHg5ODRlMDcyZjRmMWE3ZDcwZmMxZjQ1NGU2YmUwNDgxYTg0ZjY0NzlhMDM0MDI3YWNkYjAyZTJiMTg3YTVhZGQzMGFmNzBjOGE2MDYyNjY3MjA5NGU1NGE3MmJmYTM2ZWM2MjgxODZmNGRjNDBjOTc0YTlmYTkyZjBmZGZkOGIxYjFj",
    },
    miniapp: {
      version: "1",
